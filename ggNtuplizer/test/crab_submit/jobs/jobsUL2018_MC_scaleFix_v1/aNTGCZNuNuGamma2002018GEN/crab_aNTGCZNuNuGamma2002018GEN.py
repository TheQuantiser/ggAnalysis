...
workarea='/afs/hep.wisc.edu/user/wadud/private/sf_and_prefiring_fix/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2018_MC_scaleFix_v1//aNTGCZNuNuGamma2002018GEN/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/UL2018/jobsUL2018_MC_scaleFix_v1'

config                                = config()

config.General.requestName = 'aNTGCZNuNuGamma2002018GEN'
...
config.JobType.psetName  = '/afs/hep.wisc.edu/user/wadud/private/sf_and_prefiring_fix/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2018_MC_scaleFix_v1//aNTGCZNuNuGamma2002018GEN//run_mc2018_106X.py'
...
config.Data.inputDataset = '/aNTGC_ZNuNuGamma_200_2018_GEN/rusack-aNTGC_ZNuNuGamma_200_2018_MINIAODSIM-1b89fa385b00c55e6ada01fbc53a138c/USER'
