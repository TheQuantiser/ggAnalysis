...
workarea='/afs/hep.wisc.edu/user/wadud/private/sf_and_prefiring_fix/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2018_MC_scaleFix_v1//GJetsHT600ToInfTuneCP513TeVmadgraphMLMpythia8RunIISummer19UL18MiniAOD106X/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/UL2018/jobsUL2018_MC_scaleFix_v1'

config                                = config()

config.General.requestName = 'GJetsHT600ToInfTuneCP513TeVmadgraphMLMpythia8RunIISummer19UL18MiniAOD106X'
...
config.JobType.psetName  = '/afs/hep.wisc.edu/user/wadud/private/sf_and_prefiring_fix/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2018_MC_scaleFix_v1//GJetsHT600ToInfTuneCP513TeVmadgraphMLMpythia8RunIISummer19UL18MiniAOD106X//run_mc2018_106X.py'
...
config.Data.inputDataset = '/GJets_HT-600ToInf_TuneCP5_13TeV-madgraphMLM-pythia8/RunIISummer19UL18MiniAOD-106X_upgrade2018_realistic_v11_L1v1-v1/MINIAODSIM'
