...
workarea='/afs/hep.wisc.edu/user/wadud/private/sf_and_prefiring_fix/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2016PreVFP_MC_scaleFix_v1//aNTGCZNuNuGamma2002016PreVFPGEN/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/UL2016PreVFP/jobsUL2016PreVFP_MC_scaleFix_v1'

config                                = config()

config.General.requestName = 'aNTGCZNuNuGamma2002016PreVFPGEN'
...
config.JobType.psetName  = '/afs/hep.wisc.edu/user/wadud/private/sf_and_prefiring_fix/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2016PreVFP_MC_scaleFix_v1//aNTGCZNuNuGamma2002016PreVFPGEN//run_mc2016preVFP_106X.py'
...
config.Data.inputDataset = '/aNTGC_ZNuNuGamma_200_2016PreVFP_GEN/rusack-aNTGC_ZNuNuGamma_200_2016PreVFP_MINIAODSIM-890b564db4d193927f08e22fd05ac87a/USER'
