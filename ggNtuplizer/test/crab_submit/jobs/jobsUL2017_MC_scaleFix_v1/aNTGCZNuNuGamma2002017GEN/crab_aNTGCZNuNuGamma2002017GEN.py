...
workarea='/afs/hep.wisc.edu/user/wadud/private/sf_and_prefiring_fix/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2017_MC_scaleFix_v1//aNTGCZNuNuGamma2002017GEN/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/UL2017/jobsUL2017_MC_scaleFix_v1'

config                                = config()

config.General.requestName = 'aNTGCZNuNuGamma2002017GEN'
...
config.JobType.psetName  = '/afs/hep.wisc.edu/user/wadud/private/sf_and_prefiring_fix/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2017_MC_scaleFix_v1//aNTGCZNuNuGamma2002017GEN//run_mc2017_106X.py'
...
config.Data.inputDataset = '/aNTGC_ZNuNuGamma_200_2017_GEN/rusack-aNTGC_ZNuNuGamma_200_2017_MINIAODSIM-9e917789915949e1459afa5cbef42bd5/USER'
