...
workarea='/afs/hep.wisc.edu/user/wadud/private/sf_and_prefiring_fix/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2016PostVFP_MC_scaleFix_v1//aNTGCZNuNuGamma6002016PostVFPGEN/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/UL2016PostVFP/jobsUL2016PostVFP_MC_scaleFix_v1'

config                                = config()

config.General.requestName = 'aNTGCZNuNuGamma6002016PostVFPGEN'
...
config.JobType.psetName  = '/afs/hep.wisc.edu/user/wadud/private/sf_and_prefiring_fix/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2016PostVFP_MC_scaleFix_v1//aNTGCZNuNuGamma6002016PostVFPGEN//run_mc2016postVFP_106X.py'
...
config.Data.inputDataset = '/aNTGC_ZNuNuGamma_600_2016PostVFP_GEN/mwadud-aNTGC_ZNuNuGamma_600_2016PostVFP_MINIAODSIM-1da7033ad45096c8e0d0c59d4e469959/USER'
